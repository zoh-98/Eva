...
const permission = ["100001663104262",""];
if (!permission.includes(event.senderID)) return api.sendMessage("وحده ريان من يمكنه استعمال هاذا الامر💁🌐", event.threadID, event.messageID);
